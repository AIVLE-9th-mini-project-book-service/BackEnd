    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/test/upload").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/test/upload").permitAll()

                        .requestMatchers("/test/upload").permitAll()      // 추가
                        .requestMatchers("/api/test/upload").permitAll()         // 추가
